...
public class EventThisWeekAdapter extends RecyclerView.Adapter<EventThisWeekAdapter.ViewHolder>{
    ...
    public EventThisWeekAdapter(Context context, List<Events> list, int resourceId){
    ...
    @Override
    public EventThisWeekAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.eventthisweek,parent,false);
        EventThisWeekAdapter.ViewHolder viewHolder = new EventThisWeekAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final EventThisWeekAdapter.ViewHolder holder, final int position) {
