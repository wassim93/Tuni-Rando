...
public class TodayEventAdapter extends RecyclerView.Adapter<TodayEventAdapter.ViewHolder>{
    ...
    public TodayEventAdapter(Context context, List<Events> list, int resourceId) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.today_event_item,parent,false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.ev_today_title.setText(list.get(position).getTitle());
        holder.ev_today_date.setText(list.get(position).getDate());

        Picasso.with(context).load(ServerConfig.UrlForImageLocation+list.get(position).getImages().get(0))
                .memoryPolicy(MemoryPolicy.NO_CACHE)
                .networkPolicy(NetworkPolicy.NO_CACHE)
                .placeholder(R.drawable.loader).into(holder.ev_today_img);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if(response.getString("response").equals("true")){
                                ...
                                holder.ev_today_btn_more.setVisibility(View.VISIBLE);

                            }else {

                                holder.ev_today_btn_more.setVisibility(View.INVISIBLE);
                            }
        ...
        holder.ev_today_btn_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        private ImageView ev_today_img;
        private TextView ev_today_title;
        private Button ev_today_btn_more;
        private  TextView ev_today_date;
        private FrameLayout frameLayout;


        public ViewHolder(View itemView) {
            super(itemView);
            frameLayout = (FrameLayout) itemView.findViewById(R.id.evtoday_layout);
            ev_today_title = (TextView) itemView.findViewById(R.id.ev_today_title);
            ev_today_date = (TextView) itemView.findViewById(R.id.ev_today_date);
            ev_today_img =(ImageView)itemView.findViewById(R.id.ev_today_img);
            ev_today_btn_more = (Button) itemView.findViewById(R.id.ev_today_btn_more);
