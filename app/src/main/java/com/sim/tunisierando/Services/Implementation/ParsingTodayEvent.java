...
public class ParsingTodayEvent implements IParsing<Events,TodayEventAdapter> {
    @Override
    public ArrayList<Events> ArrayParse(JSONArray array, TodayEventAdapter adapter) {
